        ...
        <div class="row mg-b-25">
          ...
          <div class="col-lg-12">
            ...
            <div class="form-group mg-b-10-force">
              <label for="category_name" class="form-control-label">Edit Category <span class="tx-danger">*</span></label>
              <input class="form-control" type="text" @error('category_name') is-invalid @enderror value="{{ $category ->category_name ?? old('category_name') }}"
